...
view: +ad_group_insights_by_audience {
  ...
  dimension: ad_group_insights_by_audience_pk {
    ...
    primary_key: yes
    hidden: yes
    sql: CONCAT(CAST(${ad_group_insights_by_audience.date} AS STRING), CAST(${ad_group_insights_by_audience.youtube_ad_group_id} AS STRING), ${ad_group_insights_by_audience.youtube_audience_segment}, ${ad_group_insights_by_audience.youtube_audience_segment_type})) ;;
  }
